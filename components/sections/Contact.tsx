      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center space-y-6 mb-16">
          ...
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
            Take the first step towards effortless beauty. Our experts are here
            to answer your questions and create a personalized treatment plan.
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                >
                  ...
                  <option value="back-chest">Back & Chest</option>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <svg
                    className="w-6 h-6 text-gold-600 flex-shrink-0 mt-1"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">+43 1 234 5678</p>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="w-12 h-12 bg-gold-100 hover:bg-gold-200 rounded-xl flex items-center justify-center text-gold-600 transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
