...
const translations = {
  de: {
    ...
    p1: "Bei Laser Beauty by Narin glauben wir, dass Schönheitsbehandlungen mehr als nur effektiv sein sollten – sie sollten ein Erlebnis sein. Unser Boutique-Studio verbindet moderne Lasertechnologie mit einer ruhigen, luxuriösen Atmosphäre, die dafür geschaffen wurde, dass Sie sich verwöhnt und wohl fühlen.",
    ...
    card1Desc: "Moderne Lasertechnologie (DEKA Motus AX) für eine sanfte und möglichst angenehme Behandlung",
    ...
    card3Desc: "In Deutschland ausgebildet und geprüft – mit professionellem Lasersystem in hygienischer Umgebung",
  },
  en: {
    heading1: "Where Comfort Meets",
    heading2: "Excellence",
    p1: "At Laser Beauty by Narin, we believe that beauty treatments should be more than just effective—they should be an experience. Our boutique studio combines modern laser technology with a serene, luxurious atmosphere designed to make you feel pampered and at ease.",
    ...
    card1Desc: "Modern laser technology (DEKA Motus AX) for treatments that are as gentle and comfortable as possible",
    ...
    card3Desc: "Professionally trained in Germany with successfully passed exams, a professional laser system and a hygienic environment",
  },
  ru: {
    heading1: "Где комфорт",
    heading2: "встречает совершенство",
    p1: "В Laser Beauty by Narin мы верим, что процедуры красоты должны быть не просто эффективными – они должны быть настоящим удовольствием. Наша бутик-студия сочетает современные лазерные технологии с роскошной и спокойной атмосферой, созданной для того, чтобы вы чувствовали себя комфортно.",
    ...
    card1Desc: "Современная лазерная технология DEKA Motus AX для мягких и максимально комфортных процедур",
    ...
    card3Desc: "Обучение и сданные экзамены в Германии, профессиональная лазерная система и гигиеничная среда",
  },
};
